      ...
      <div className="admin-page-container">
        ...
        <div>
          <Table aria-label="pets" className="mt-4">
            <thead>
              <tr>
                <th style={{ backgroundColor: "#B48969" }} >Name</th>
                <th style={{ backgroundColor: "#B48969" }} >Birth Date</th>
                <th style={{ backgroundColor: "#B48969" }} >Type</th>
                <th style={{ backgroundColor: "#B48969" }} >Owner</th>
                <th style={{ backgroundColor: "#B48969" }} >Visits</th>
