      ...
      <div className="admin-page-container">
        ...
        <div>
          <Table aria-label="owners" className="mt-4">
            <thead>
              <tr>
                <th style={{ backgroundColor: "#B48969" }} width="10%">Name</th>
                <th style={{ backgroundColor: "#B48969" }} width="10%">Address</th>
                <th style={{ backgroundColor: "#B48969" }} width="10%">City</th>
                <th style={{ backgroundColor: "#B48969" }} width="10%">Telephone</th>
                <th style={{ backgroundColor: "#B48969" }} width="10%">User</th>
                <th style={{ backgroundColor: "#B48969" }} width="10%">Clinic</th>
                <th style={{ backgroundColor: "#B48969" }} width="40%">Actions</th>
              </tr>
            </thead>
