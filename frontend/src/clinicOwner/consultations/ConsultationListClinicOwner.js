        ...
        <div>
            <Container fluid style={{ marginTop: "15px" }}>
                ...
                <Table aria-label='consultations' className="mt-4">
                    <thead>
                        <tr>
                            <th style={{ backgroundColor: "#B48969" }} >Title</th>
                            <th style={{ backgroundColor: "#B48969" }} >Status</th>
                            <th style={{ backgroundColor: "#B48969" }} >Owner</th>
                            <th style={{ backgroundColor: "#B48969" }} >Pet</th>
                            <th style={{ backgroundColor: "#B48969" }} >Clinic</th>
                            <th style={{ backgroundColor: "#B48969" }} >Sent To</th>
                            <th style={{ backgroundColor: "#B48969" }} >Creation Date</th>
                            <th style={{ backgroundColor: "#B48969" }} >Actions</th>
                        </tr>
                    </thead>
