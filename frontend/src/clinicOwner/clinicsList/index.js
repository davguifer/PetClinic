          ...
          <Table aria-label="clinics" className="mt-4">
            <thead>
              <tr>
                ...
                <th style={{ backgroundColor: "#B48969" }} width="15%" className="text-center">Address</th>
                <th style={{ backgroundColor: "#B48969" }} width="15%" className="text-center">Telephone</th>
                <th style={{ backgroundColor: "#B48969" }} width="15%" className="text-center">Plan</th>
