...
INSERT INTO rooms(id,name,clinic_id,pet_type_id,size) VALUES (1,'Room 1',1,1,20);
INSERT INTO rooms(id,name,clinic_id,pet_type_id,size) VALUES (2,'Room 2',2,2,30);
INSERT INTO rooms(id,name,clinic_id,pet_type_id,size) VALUES (3,'Room 3',3,3,40);
INSERT INTO rooms(id,name,clinic_id,pet_type_id,size) VALUES (4,'Room 4',1,1,25);
INSERT INTO rooms(id,name,clinic_id,pet_type_id,size) VALUES (5,'Room 5',1,2,35);
INSERT INTO rooms(id,name,clinic_id,pet_type_id,size) VALUES (6,'Room 6',1,3,45);
INSERT INTO rooms(id,name,clinic_id,pet_type_id,size) VALUES (7,'Room 7',1,4,45);
INSERT INTO rooms(id,name,clinic_id,pet_type_id,size) VALUES (8,'Room 8',1,5,15);
INSERT INTO rooms(id,name,clinic_id,pet_type_id,size) VALUES (9,'Room 9',1,6,25);
INSERT INTO rooms(id,name,clinic_id,pet_type_id,size) VALUES (10,'Room 10',1,7,55);

INSERT INTO bookings(id, pet_id, pet_room_id, start_date, end_date) VALUES (1,1,1,'2024-05-14', '2024-06-02');
INSERT INTO bookings(id, pet_id, pet_room_id, start_date, end_date) VALUES (2,1,1,'2024-06-03', '2024-06-10');
INSERT INTO bookings(id, pet_id, pet_room_id, start_date, end_date) VALUES (3,10,2,'2024-05-14', '2024-06-02');

INSERT INTO adoptions(id,owner_id, pet_id, description,is_accepted) VALUES
(1,1, 1, 'Descripción de la adopción 1',false),
(2,2, 2, 'Descripción de la adopción 2',false),
(3,3, 3, 'Descripción de la adopción 3',false);